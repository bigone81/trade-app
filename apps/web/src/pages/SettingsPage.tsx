    ...
    <div className="page settings-page">
      ...
      <div className="settings-grid">
        ...
        <section className="card settings-card trading-overlay-settings">
          ...
          <label className="setting-check nested"><input type="checkbox" checked={preferences.tradingOverlays.showTradeConnections} onChange={(e)=>save({...preferences,tradingOverlays:{...preferences.tradingOverlays,showTradeConnections:e.target.checked}})}/> {preferences.language==='uk'?'Пунктирні лінії: вхід → вихід Bybit':preferences.language==='ru'?'Пунктирные линии: вход → выход Bybit':'Dotted Bybit entry → exit lines'}</label>
          ...
          <label className="setting-check"><input type="checkbox" checked={preferences.tradingOverlays.allowDragOrders} onChange={(e)=>save({...preferences,tradingOverlays:{...preferences.tradingOverlays,allowDragOrders:e.target.checked}})}/> {t('Allow dragging pending order / trigger price')}</label>
          ...
          <p className="muted settings-hint">{t('Order/Trigger/SL/TP lines come from the exchange and are separate from Manual Levels. Position Entry is read-only.')}</p>
